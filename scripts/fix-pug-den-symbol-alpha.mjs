/**
 * Clear pure-black mats from Pug Den tiles / card frame.
 * Run: node scripts/fix-pug-den-symbol-alpha.mjs
 */
...
const DIR = path.join(__dirname, "..", "public", "images", "symbols", "pug-den");
const THRESH = 18;
