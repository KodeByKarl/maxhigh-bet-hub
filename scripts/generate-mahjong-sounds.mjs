/**
 * Regenerates Mahjong Ways spin SFX (ceramic tile clacks + soft pentatonic color).
...
const OUT_DIR = path.join(__dirname, "..", "public", "sounds", "mahjong-ways");
...
console.log("Mahjong Ways sounds written to", OUT_DIR);
