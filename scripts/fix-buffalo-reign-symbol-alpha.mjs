/**
 * Clear pure-black mats from Wild Frontier Stampede tiles.
 * Run: node scripts/fix-buffalo-reign-symbol-alpha.mjs
 */
...
const DIR = path.join(__dirname, "..", "public", "images", "symbols", "buffalo-reign");
const THRESH = 12;
