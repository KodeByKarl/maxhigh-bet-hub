/**
 * Clear pure-black mats from Fire Spike tiles.
 * Run: node scripts/fix-fire-spike-symbol-alpha.mjs
 */
...
const DIR = path.join(__dirname, "..", "public", "images", "symbols", "fire-spike");
const THRESH = 18;
