...
import { GoalRushIcon } from "./GoalRushIcon";

export type ReelPhase = "idle" | "spinning" | "stopping" | "win";

const SPIN_STRIP: GrSymKind[] = ["bar", "dice", "diamond", "chip", "lucky7", "wild", "scatter"];
...
/**
 * Goal Rush cell — CSS win ring with smooth fade-out (no hard cut).
 */
