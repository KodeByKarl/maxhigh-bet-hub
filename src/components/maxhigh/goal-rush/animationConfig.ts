import type { GrSymKind } from "@/lib/goal-rush-config";
...
export const ICON_SRC: Record<GrSymKind, string> = {
  bar: "/images/symbols/goal-rush/bar.webp",
  dice: "/images/symbols/goal-rush/dice.webp",
  diamond: "/images/symbols/goal-rush/diamond.webp",
  chip: "/images/symbols/goal-rush/chip.webp",
  lucky7: "/images/symbols/goal-rush/lucky7.webp",
  wild: "/images/symbols/goal-rush/wild.webp",
  scatter: "/images/symbols/goal-rush/scatter.webp",
};

/** Ornate metal frame overlay (Frontier-style card border, fire palette). */
export const CARD_FRAME_SRC = "/images/symbols/goal-rush/card-frame.png";
