/**
 * Gold Mine Dig — western Hold & Win SFX.
 * Assets from scripts/generate-gold-mine-sounds.mjs
 */
const BASE = "/sounds/gold-mine";
...
export const goldMineAudio = new GoldMineAudio();
