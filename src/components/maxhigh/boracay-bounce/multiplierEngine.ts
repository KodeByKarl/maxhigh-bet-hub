/**
 * Position-based cascade multipliers (Boracay Bounce–style).
...
/**
 * Boracay Bounce–style cell tint: soft pink → hot magenta → purple → gold at max.
...
/**
 * Apply position multipliers to cascade raw win (Boracay Bounce end-of-cascade rule).
