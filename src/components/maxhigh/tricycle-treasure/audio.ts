/**
 * Tricycle Treasure — western Hold & Win SFX.
 * Assets from scripts/generate-tricycle-treasure-sounds.mjs
 */
const BASE = "/sounds/tricycle-treasure";
...
export const tricycleTreasureAudio = new TricycleTreasureAudio();
