...
export const TILE_IMAGE_MAP: Record<FgSymKind, string> = {
  sym_j: "/images/symbols/tricycle-treasure/j.png",
  sym_q: "/images/symbols/tricycle-treasure/q.png",
  sym_k: "/images/symbols/tricycle-treasure/k.png",
  sym_a: "/images/symbols/tricycle-treasure/a.png",
  sheriff: "/images/symbols/tricycle-treasure/sheriff.png",
  bartender: "/images/symbols/tricycle-treasure/bartender.png",
  banker: "/images/symbols/tricycle-treasure/banker.png",
  bandit: "/images/symbols/tricycle-treasure/bandit.png",
  safe: "/images/symbols/tricycle-treasure/safe.png",
  wild: "/images/symbols/tricycle-treasure/wild.png",
  scatter: "/images/symbols/tricycle-treasure/scatter.png",
  bonus: "/images/symbols/tricycle-treasure/bonus.png",
};

type Props = { kind: FgSymKind; className?: string; coinLabel?: string };

/**
 * Tricycle Treasure symbol — square PNG art clipped to a circle (matches Pug Den cells).
 */
export const TricycleTreasureIcon = memo(function TricycleTreasureIcon({ kind, className, coinLabel }: Props) {
