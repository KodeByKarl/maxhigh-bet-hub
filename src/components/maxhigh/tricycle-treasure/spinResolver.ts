import { calcFreeSpinsAward } from "@/lib/tricycle-treasure-config";
...
import { getTricycleTreasureConfig } from "./runtimeConfig";
 ...
 */
export function resolveTricycleTreasureSpin(opts: {
  totalBet: number;
  isFreeSpins?: boolean;
  seed?: string;
}): SpinScript {
