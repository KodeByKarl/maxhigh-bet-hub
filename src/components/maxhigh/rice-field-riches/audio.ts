/**
 * Rice Field Riches � carabao / vault SFX.
 * Assets from scripts/generate-rice-field-riches-sounds.mjs
 */
const BASE = "/sounds/rice-field-riches";
...
export const riceFieldRichesAudio = new RiceFieldRichesAudio();
