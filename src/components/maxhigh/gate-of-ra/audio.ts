/**
 * Gate of Ra — Web Audio sound design.
 ...
 */
const BASE = "/sounds/gate-of-ra";

export const GATE_OF_RA_SOUND_FILES = {
...
type SoundId = keyof typeof GATE_OF_RA_SOUND_FILES;

const MUTE_KEY = "gate-of-ra-muted";
const VOL_KEY = "gate-of-ra-volume";
...
class GateOfRaAudio {
  ...
  get isReady() {
    return this.buffers.size === Object.keys(GATE_OF_RA_SOUND_FILES).length;
  }
  ...
  private async loadAll(onProgress?: ProgressCb) {
    const entries = Object.entries(GATE_OF_RA_SOUND_FILES) as [SoundId, string][];
...
export const gateOfRaAudio = new GateOfRaAudio();
