import type { McSymKind } from "@/lib/cash-mania-config";
...
export const ICON_SRC: Record<McSymKind, string> = {
  bar: "/images/symbols/cash-mania/bar.webp",
  dice: "/images/symbols/cash-mania/dice.webp",
  diamond: "/images/symbols/cash-mania/diamond.webp",
  chip: "/images/symbols/cash-mania/chip.webp",
  lucky7: "/images/symbols/cash-mania/lucky7.webp",
  wild: "/images/symbols/cash-mania/wild.webp",
  scatter: "/images/symbols/cash-mania/scatter.webp",
};

/** Ornate metal frame overlay (Frontier-style card border, fire palette). */
export const CARD_FRAME_SRC = "/images/symbols/cash-mania/card-frame.png";
