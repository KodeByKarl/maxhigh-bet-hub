...
/**
 * 3D symbol glyph — transparent PNGs under /images/symbols/fiesta-fireworks/.
 * Sized large for readability (older players).
 */
export const FiestaFireworksIcon = memo(function FiestaFireworksIcon({
  kind,
  className,
  extraLabel,
}: FiestaFireworksIconProps) {
