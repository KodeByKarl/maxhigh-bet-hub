/**
 * Fiesta Fireworks — themed SFX (firecrackers, gongs, pentatonic luck).
 * Assets from scripts/generate-fiesta-fireworks-sounds.mjs
 */
const BASE = "/sounds/fiesta-fireworks";
...
export const fiestaFireworksAudio = new FiestaFireworksAudio();
