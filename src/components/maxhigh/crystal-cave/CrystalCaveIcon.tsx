...
export const TILE_IMAGE_MAP: Record<FgSymKind, string> = {
  sym_j: "/images/symbols/crystal-cave/j.png",
  sym_q: "/images/symbols/crystal-cave/q.png",
  sym_k: "/images/symbols/crystal-cave/k.png",
  sym_a: "/images/symbols/crystal-cave/a.png",
  sheriff: "/images/symbols/crystal-cave/sheriff.png",
  bartender: "/images/symbols/crystal-cave/bartender.png",
  banker: "/images/symbols/crystal-cave/banker.png",
  bandit: "/images/symbols/crystal-cave/bandit.png",
  safe: "/images/symbols/crystal-cave/safe.png",
  wild: "/images/symbols/crystal-cave/wild.png",
  scatter: "/images/symbols/crystal-cave/scatter.png",
  bonus: "/images/symbols/crystal-cave/bonus.png",
};

type Props = { kind: FgSymKind; className?: string; coinLabel?: string };

/**
 * Crystal Cave symbol — square PNG art clipped to a circle (matches Pug Den cells).
 */
export const CrystalCaveIcon = memo(function CrystalCaveIcon({ kind, className, coinLabel }: Props) {
