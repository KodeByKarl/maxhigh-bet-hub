/**
 * Crystal Cave — western Hold & Win SFX.
 * Assets from scripts/generate-crystal-cave-sounds.mjs
 */
const BASE = "/sounds/crystal-cave";
...
export const crystalCaveAudio = new CrystalCaveAudio();
