...
import type { LuckyBarsConfig } from "@/lib/lucky-bars-config";
...
export type ResolveLuckyBarsSpinOpts = {
  totalBet: number;
  seed?: string;
...
export function resolveLuckyBarsSpin(opts: ResolveLuckyBarsSpinOpts): SpinScript {
  const cfg = opts.cfg ?? getLuckyBarsConfig();
