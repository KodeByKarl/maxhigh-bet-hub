import type { RrSymKind, LuckyBarsConfig } from "@/lib/lucky-bars-config";
...
function pickSymbol(rng: RrRng, cfg: LuckyBarsConfig, reel: number): RrSymKind {
...
export function generateReels(rng: RrRng, cfg: LuckyBarsConfig): RrReels {
