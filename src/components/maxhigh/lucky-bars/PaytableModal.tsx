...
import type { RrSymKind } from "@/lib/lucky-bars-config";
import { SYM_NAME } from "./animationConfig";
import { getLuckyBarsConfig } from "./runtimeConfig";
import { LuckyBarsIcon } from "./LuckyBarsIcon";
...
const HOWTO_IMG = {
  payline: "/images/lucky-bars/howto/win-payline.png",
  threeFruit: "/images/lucky-bars/howto/win-three-fruit.png",
  twoWild: "/images/lucky-bars/howto/win-two-wild.png",
  bonus: "/images/lucky-bars/howto/win-bonus-ladder.png",
} as const;
      ...
      <div className="flex items-center gap-1.5 rounded-2xl border border-white/25 bg-black/35 px-2 py-1.5">
        {kinds.map((k, i) => (
          <div key={`${k}-${i}`} className="size-11 shrink-0 sm:size-12">
            <LuckyBarsIcon kind={k} framed={false} />
          </div>
        ))}
      </div>
                ...
                return (
                  ...
                  >
                    <div className="size-12 shrink-0">
                      <LuckyBarsIcon kind={kind} framed={false} />
                    </div>
