...
/** Large jade altar tile for the 3×3 board. */
  ...
  return (
    <div
      className={cn(
        ...
        "border-[2.5px] bg-[#04140f]/95 shadow-[0_6px_18px_rgba(0,0,0,0.45),inset_0_0_18px_rgba(16,185,129,0.16)]",
      ...
      style={{
        borderColor: isWinLit
          ? "var(--p-accent-soft)"
          : "color-mix(in srgb, var(--p-accent) 65%, transparent)",
        boxShadow: isWinLit
          ? "0 0 22px var(--p-spin-shadow), inset 0 0 16px rgba(52,211,153,0.35)"
          : undefined,
      }}
    >
      {cell && (
        ...
        >
          ...
          {isWinLit && perPay != null && perPay > 0 && (
            <span
              className="absolute top-2 left-1/2 z-[2] -translate-x-1/2 whitespace-nowrap rounded-full border border-white/90 px-2 py-0.5 text-[9px] font-black tabular-nums shadow-sm sm:text-[11px]"
              style={{
                background:
