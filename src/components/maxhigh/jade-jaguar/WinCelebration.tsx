...
/** Jade Jaguar win overlay — emerald temple / jade gem. */
            ...
            style={{
              ...
              filter:
                i % 2 === 0
                  ...
                  : "drop-shadow(0 0 10px rgba(167,243,208,0.85))",
            }}
          >
            {i % 3 === 0 ? "✦" : i % 3 === 1 ? "◈" : "✧"}
          </motion.div>
      ...
      >
            ...
            ch === " " ? (
              ...
              <motion.span
                ...
                style={{
                  ...
                  WebkitTextStroke: "0.1em #064E3B",
                  paintOrder: "stroke fill",
                  textShadow:
                    "0 0.08em 0 #065F46, 0 0.16em 0.22em rgba(0,0,0,0.45)",
                }}
              >
                {ch}
              </motion.span>
        ...
        {showMultPanel ? (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, #D1FAE5 0%, #10B981 45%, #064E3B 100%)",
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  color: "#A7F3D0",
                  textShadow: "0 3px 0 #064E3B, 0 6px 10px rgba(0,0,0,0.45)",
        ...
        {showMultPanel && shownMult > 1 ? (
          <motion.div
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, rgba(6,78,59,0.96), rgba(2,12,10,0.98))",
              boxShadow: "0 10px 28px rgba(0,0,0,0.4)",
            }}
          >
            <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-end gap-1 text-white">
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-emerald-200/90">
                  Total Earn
                </div>
                <div className="truncate font-black tabular-nums text-base text-[#A7F3D0] sm:text-lg">
                  ₱{shownEarn.toFixed(2)}
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-emerald-100/60">×</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-teal-200/90">
                  Multiplier
                </div>
                <div className="font-black tabular-nums text-base text-[#6EE7B7] sm:text-lg">
                  {shownMult}x
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-emerald-100/60">=</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-emerald-100/90">
                  Total
                </div>
                <div className="truncate font-black tabular-nums text-base text-[#A7F3D0] sm:text-lg">
                  ₱{amount.toFixed(2)}
        ...
        <div className="relative z-[1] w-full px-1">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #ECFDF5 0%, #6EE7B7 22%, #059669 55%, #064E3B 100%)",
              boxShadow:
                "0 10px 32px rgba(16,185,129,0.55), inset 0 3px 10px rgba(255,255,255,0.45), inset 0 -4px 10px rgba(6,78,59,0.35)",
              border: "4px solid rgba(209,250,229,0.85)",
            }}
          >
            <div
            ...
            <motion.div
              ...
              style={{
                ...
                color: "#ECFDF5",
                textShadow: "0 3px 0 #064E3B, 0 7px 16px rgba(2,12,10,0.55)",
                WebkitTextStroke: "1.5px rgba(6,78,59,0.45)",
              }}
            >
              ₱{amount.toFixed(2)}
            </motion.div>
