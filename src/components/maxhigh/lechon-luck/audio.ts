/**
 * Lechon Luck — themed SFX (firecrackers, gongs, pentatonic luck).
 * Assets from scripts/generate-lechon-luck-sounds.mjs
 */
const BASE = "/sounds/lechon-luck";
...
export const lechonLuckAudio = new LechonLuckAudio();
