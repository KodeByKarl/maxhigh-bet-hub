...
import { SYMBOL_NAMES, type SuperAceSymKind } from "@/lib/super-ace-config";
import { getSuperAceConfig } from "./runtimeConfig";
import { SuperAceIcon } from "./SuperAceIcon";
...
const PAY_ORDER: SuperAceSymKind[] = [
  "ace_gold",
  "diamond",
  "club",
  "heart",
...
const HOWTO_IMG = {
  ways: "/images/super-ace/howto/win-ways.png",
  threeCards: "/images/super-ace/howto/win-three-cards.png",
  goldenJoker: "/images/super-ace/howto/win-golden-joker.png",
  cascade: "/images/super-ace/howto/win-cascade.png",
  freeSpins: "/images/super-ace/howto/win-free-spins.png",
} as const;

function PatternStrip({ kinds, label }: { kinds: SuperAceSymKind[]; label: string }) {
  return (
