/**
 * Pirate Plunder — Web Audio Sound Engine & Theme Music Synthesizer.
 * Commercial-safe, procedural Web Audio synthesized sounds and jungle ambient beat.
 */

const MUTE_KEY = "pirate-plunder-muted";
const VOL_KEY = "pirate-plunder-volume";

class PiratePlunderAudio {
  ...
  /**
   * Pirate Plunder Scatter Trigger Stinger (Roar + Majestic Chimes).
   */
  playScatterTrigger() {
    this.stopSpinLoop();
    const ctx = this.ensureCtx();
...
export const piratePlunderAudio = new PiratePlunderAudio();
