...
/** Frost ice letter accents — sky + frost white. */
const LETTER_COLORS = [
  "#E0F2FE",
  "#7DD3FC",
  "#BAE6FD",
...
/** Frost Fox win overlay — glacial blue / ice crystal. */
            ...
            style={{
              ...
              filter:
                i % 2 === 0
                  ...
                  : "drop-shadow(0 0 10px rgba(224,242,254,0.85))",
            }}
          >
            {i % 3 === 0 ? "✦" : i % 3 === 1 ? "❄" : "✧"}
          </motion.div>
      ...
      >
            ...
            ch === " " ? (
              ...
              <motion.span
                ...
                style={{
                  ...
                  WebkitTextStroke: "0.1em #0C4A6E",
                  paintOrder: "stroke fill",
                  textShadow:
                    "0 0.08em 0 #075985, 0 0.16em 0.22em rgba(0,0,0,0.45)",
                }}
              >
                {ch}
              </motion.span>
        ...
        {showMultPanel ? (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, #E0F2FE 0%, #0284C7 45%, #1E3A8A 100%)",
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  color: "#BAE6FD",
                  textShadow: "0 3px 0 #0C4A6E, 0 6px 10px rgba(0,0,0,0.45)",
        ...
        {showMultPanel && shownMult > 1 ? (
          <motion.div
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, rgba(12,74,110,0.96), rgba(15,23,42,0.98))",
              boxShadow: "0 10px 28px rgba(0,0,0,0.4)",
            }}
          >
            <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-end gap-1 text-white">
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-sky-200/90">
                  Total Earn
                </div>
                <div className="truncate font-black tabular-nums text-base text-[#BAE6FD] sm:text-lg">
                  ₱{shownEarn.toFixed(2)}
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-sky-100/60">×</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-indigo-200/90">
                  Multiplier
                </div>
                <div className="font-black tabular-nums text-base text-[#7DD3FC] sm:text-lg">
                  {shownMult}x
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-sky-100/60">=</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-sky-100/90">
                  Total
                </div>
                <div className="truncate font-black tabular-nums text-base text-[#BAE6FD] sm:text-lg">
                  ₱{amount.toFixed(2)}
        ...
        <div className="relative z-[1] w-full px-1">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #E0F2FE 0%, #7DD3FC 22%, #0284C7 55%, #1E3A8A 100%)",
              boxShadow:
                "0 10px 32px rgba(14,165,233,0.55), inset 0 3px 10px rgba(255,255,255,0.45), inset 0 -4px 10px rgba(15,23,42,0.35)",
              border: "4px solid rgba(224,242,254,0.85)",
            }}
          >
            <div
              className="relative text-center text-[10px] font-black uppercase tracking-[0.18em]"
              style={{ color: "rgba(240,249,255,0.95)" }}
            >
              Total Win
            </div>
            <motion.div
              ...
              style={{
                ...
                color: "#F0F9FF",
                textShadow: "0 3px 0 #0C4A6E, 0 7px 16px rgba(15,23,42,0.55)",
                WebkitTextStroke: "1.5px rgba(12,74,110,0.45)",
              }}
            >
              ₱{amount.toFixed(2)}
            </motion.div>
