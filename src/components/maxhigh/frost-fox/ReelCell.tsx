...
/**
 * Frost ice tile — rounded square (no hex clip). Full glyph stays visible.
 */
export const ReelCell = memo(function ReelCell({
  ...
  return (
    <div
      className={cn(
        "relative aspect-square w-full overflow-hidden rounded-2xl isolate",
        "border-2 bg-[#061018]/95 shadow-[0_4px_14px_rgba(0,0,0,0.4),inset_0_0_12px_rgba(14,165,233,0.12)]",
      ...
      style={{
        ...
        boxShadow: isWinLit
          ? "0 0 18px var(--p-spin-shadow), inset 0 0 12px rgba(56,189,248,0.28)"
          : undefined,
      }}
    >
      {cell && (
