...
import { getMysticRunesConfig, getRuntimeSymbols } from "./runtimeConfig";
...
export const ICON_SRC: Record<SymKind, string> = {
  ten: "/images/symbols/mystic-runes/ten.png",
  jack: "/images/symbols/mystic-runes/jack.png",
  queen: "/images/symbols/mystic-runes/queen.png",
  king: "/images/symbols/mystic-runes/king.png",
  ace: "/images/symbols/mystic-runes/ace.png",
  scarab: "/images/symbols/mystic-runes/scarab.png",
  ankh: "/images/symbols/mystic-runes/ankh.png",
  horus: "/images/symbols/mystic-runes/horus.png",
  anubis: "/images/symbols/mystic-runes/anubis.png",
  pharaoh: "/images/symbols/mystic-runes/pharaoh.png",
  wild: "/images/symbols/mystic-runes/wild.png",
  scatter: "/images/symbols/mystic-runes/scatter.png",
};
...
export function scatterCashPay(count: number, bet: number): number {
  const tiers = [...getMysticRunesConfig().scatterCashTiers].sort((a, b) => b.count - a.count);
...
export function getBuyFeatureMult() {
  return getMysticRunesConfig().buyFeatureMult;
}

export function getFreeSpinsRetrigger() {
  return getMysticRunesConfig().freeSpinsRetrigger;
}

export function getFsMultStart() {
  return getMysticRunesConfig().fsMultStart;
}

export function getFsMultStep() {
  return getMysticRunesConfig().fsMultStep;
}
...
export const ASSET = {
  backdrop: "/images/symbols/mystic-runes/backdrop.webp?v=3",
  mascot: "/images/symbols/mystic-runes/mascot-cut.webp?v=4",
} as const;
