...
import {
  FR_MULTIPLIER_VALUES,
  SYMBOL_NAMES,
  type FrSymKind,
} from "@/lib/fortune-rabbit-config";
import { FortuneRabbitIcon } from "./FortuneRabbitIcon";
import { getFortuneRabbitConfig } from "./runtimeConfig";
              ...
              return (
                ...
                >
                  <div className="size-11 shrink-0 sm:size-12">
                    <FortuneRabbitIcon kind={kind} framed={false} />
                  </div>
