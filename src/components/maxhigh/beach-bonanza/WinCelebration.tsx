    ...
    >
      ...
      >
        ...
        {showMultPanel ? (
          ...
          >
            <div
              className="rounded-[1rem] border-2 border-white/80 px-4 py-3 text-center"
              style={{
                background:
                  "radial-gradient(circle at 35% 20%, #e0f2fe 0%, #38bdf8 42%, #0284c7 100%)",
              }}
            >
              <div
