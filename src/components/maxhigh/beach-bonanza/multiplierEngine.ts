/**
 * Position-based cascade multipliers (Beach Bonanza–style).
...
/**
 * Beach Bonanza–style cell tint: soft pink → hot magenta → purple → gold at max.
...
/**
 * Apply position multipliers to cascade raw win (Beach Bonanza end-of-cascade rule).
