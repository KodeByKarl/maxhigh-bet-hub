import type { RoyalAceSymbolConfig, RoyalAceSymKind } from "@/lib/royal-ace-config";
...
export function pickRandomSymbol(ante: boolean, isFreeSpins: boolean): RoyalAceSymbolConfig {
