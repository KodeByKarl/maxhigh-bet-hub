...
import { SYMBOL_NAMES, type RoyalAceSymKind } from "@/lib/royal-ace-config";
import { getRoyalAceConfig } from "./runtimeConfig";
import { RoyalAceIcon } from "./RoyalAceIcon";
...
const PAY_ORDER: RoyalAceSymKind[] = [
  "ace_gold",
  "diamond",
  "club",
  "heart",
...
const HOWTO_IMG = {
  ways: "/images/royal-ace/howto/win-ways.png",
  threeCards: "/images/royal-ace/howto/win-three-cards.png",
  goldenJoker: "/images/royal-ace/howto/win-golden-joker.png",
  cascade: "/images/royal-ace/howto/win-cascade.png",
  freeSpins: "/images/royal-ace/howto/win-free-spins.png",
} as const;

function PatternStrip({ kinds, label }: { kinds: RoyalAceSymKind[]; label: string }) {
  return (
