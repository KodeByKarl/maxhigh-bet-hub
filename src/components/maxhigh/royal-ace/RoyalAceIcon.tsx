...
import type { RoyalAceSymKind } from "@/lib/royal-ace-config";

export const TILE_IMAGE_MAP: Record<RoyalAceSymKind, string> = {
  sym_j: "/images/symbols/royal-ace/j.png",
  sym_q: "/images/symbols/royal-ace/q.png",
  sym_k: "/images/symbols/royal-ace/k.png",
  sym_a: "/images/symbols/royal-ace/a.png",
  spade: "/images/symbols/royal-ace/spade.png",
  heart: "/images/symbols/royal-ace/heart.png",
  club: "/images/symbols/royal-ace/club.png",
  diamond: "/images/symbols/royal-ace/diamond.png",
  ace_gold: "/images/symbols/royal-ace/ace_gold.png",
  little_joker: "/images/symbols/royal-ace/little_joker.png",
  big_joker: "/images/symbols/royal-ace/big_joker.png",
  scatter: "/images/symbols/royal-ace/scatter.png",
};

type RoyalAceIconProps = {
...
/**
 * 3D Lucky Poker tile art � PNG symbols under /images/symbols/royal-ace/.
 */
export const RoyalAceIcon = memo(function RoyalAceIcon({
  kind,
  isGold,
  className,
}: RoyalAceIconProps) {
