...
import { MoneyComingIcon } from "./MoneyComingIcon";
...
/**
 * Money Coming cell — CSS win ring with smooth fade-out (no hard cut).
 */
      ...
      {spinning ? (
        ...
        >
          {strip.map((sym, i) => (
            ...
            >
              <MoneyComingIcon kind={sym} framed />
            </div>
          ))}
        </div>
      ) : (
