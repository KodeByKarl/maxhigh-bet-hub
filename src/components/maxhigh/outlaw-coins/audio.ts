/**
 * Outlaw Coins — western Hold & Win SFX.
 * Assets from scripts/generate-outlaw-coins-sounds.mjs
 */
const BASE = "/sounds/outlaw-coins";
...
export const outlawCoinsAudio = new OutlawCoinsAudio();
