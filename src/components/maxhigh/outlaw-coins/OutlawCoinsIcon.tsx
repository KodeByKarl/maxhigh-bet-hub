...
export const TILE_IMAGE_MAP: Record<FgSymKind, string> = {
  sym_j: "/images/symbols/outlaw-coins/j.png",
  sym_q: "/images/symbols/outlaw-coins/q.png",
  sym_k: "/images/symbols/outlaw-coins/k.png",
  sym_a: "/images/symbols/outlaw-coins/a.png",
  sheriff: "/images/symbols/outlaw-coins/sheriff.png",
  bartender: "/images/symbols/outlaw-coins/bartender.png",
  banker: "/images/symbols/outlaw-coins/banker.png",
  bandit: "/images/symbols/outlaw-coins/bandit.png",
  safe: "/images/symbols/outlaw-coins/safe.png",
  wild: "/images/symbols/outlaw-coins/wild.png",
  scatter: "/images/symbols/outlaw-coins/scatter.png",
  bonus: "/images/symbols/outlaw-coins/bonus.png",
};

type Props = { kind: FgSymKind; className?: string; coinLabel?: string };

/**
 * Outlaw Coins symbol — square PNG art clipped to a circle (matches Pug Den cells).
 */
export const OutlawCoinsIcon = memo(function OutlawCoinsIcon({ kind, className, coinLabel }: Props) {
