...
import { getOlympusWrathConfig, getRuntimeSymbols } from "./runtimeConfig";
...
export const ICON_SRC: Record<SymKind, string> = {
  ten: "/images/symbols/olympus-wrath/ten.png",
  jack: "/images/symbols/olympus-wrath/jack.png",
  queen: "/images/symbols/olympus-wrath/queen.png",
  king: "/images/symbols/olympus-wrath/king.png",
  ace: "/images/symbols/olympus-wrath/ace.png",
  scarab: "/images/symbols/olympus-wrath/scarab.png",
  ankh: "/images/symbols/olympus-wrath/ankh.png",
  horus: "/images/symbols/olympus-wrath/horus.png",
  anubis: "/images/symbols/olympus-wrath/anubis.png",
  pharaoh: "/images/symbols/olympus-wrath/pharaoh.png",
  wild: "/images/symbols/olympus-wrath/wild.png",
  scatter: "/images/symbols/olympus-wrath/scatter.png",
};
...
export function scatterCashPay(count: number, bet: number): number {
  const tiers = [...getOlympusWrathConfig().scatterCashTiers].sort((a, b) => b.count - a.count);
...
export function getBuyFeatureMult() {
  return getOlympusWrathConfig().buyFeatureMult;
}

export function getFreeSpinsRetrigger() {
  return getOlympusWrathConfig().freeSpinsRetrigger;
}

export function getFsMultStart() {
  return getOlympusWrathConfig().fsMultStart;
}

export function getFsMultStep() {
  return getOlympusWrathConfig().fsMultStep;
}
...
export const ASSET = {
  backdrop: "/images/symbols/olympus-wrath/backdrop.webp?v=3",
  mascot: "/images/symbols/olympus-wrath/mascot-cut.webp?v=4",
} as const;
