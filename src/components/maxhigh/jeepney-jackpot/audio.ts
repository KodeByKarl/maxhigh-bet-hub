/**
 * Jeepney Jackpot — western Hold & Win SFX.
 * Assets from scripts/generate-jeepney-jackpot-sounds.mjs
 */
const BASE = "/sounds/jeepney-jackpot";
...
export const jeepneyJackpotAudio = new JeepneyJackpotAudio();
