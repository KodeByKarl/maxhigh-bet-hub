...
export const TILE_IMAGE_MAP: Record<FgSymKind, string> = {
  sym_j: "/images/symbols/jeepney-jackpot/j.png",
  sym_q: "/images/symbols/jeepney-jackpot/q.png",
  sym_k: "/images/symbols/jeepney-jackpot/k.png",
  sym_a: "/images/symbols/jeepney-jackpot/a.png",
  sheriff: "/images/symbols/jeepney-jackpot/sheriff.png",
  bartender: "/images/symbols/jeepney-jackpot/bartender.png",
  banker: "/images/symbols/jeepney-jackpot/banker.png",
  bandit: "/images/symbols/jeepney-jackpot/bandit.png",
  safe: "/images/symbols/jeepney-jackpot/safe.png",
  wild: "/images/symbols/jeepney-jackpot/wild.png",
  scatter: "/images/symbols/jeepney-jackpot/scatter.png",
  bonus: "/images/symbols/jeepney-jackpot/bonus.png",
};

type Props = { kind: FgSymKind; className?: string; coinLabel?: string };

/**
 * Jeepney Jackpot symbol — square PNG art clipped to a circle (matches Pug Den cells).
 */
export const JeepneyJackpotIcon = memo(function JeepneyJackpotIcon({ kind, className, coinLabel }: Props) {
