import { totalCells, type JeepneyJackpotConfig } from "@/lib/jeepney-jackpot-config";
import { pickWeighted, type Rng } from "./rng";
import type { HoldCoin, HoldWinScript, HoldWinStep } from "./types";

function rollCoin(rng: Rng, cfg: JeepneyJackpotConfig, _totalBet: number): HoldCoin {
