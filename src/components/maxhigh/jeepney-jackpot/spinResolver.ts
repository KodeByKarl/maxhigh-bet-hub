import { calcFreeSpinsAward } from "@/lib/jeepney-jackpot-config";
...
import { getJeepneyJackpotConfig } from "./runtimeConfig";
 ...
 */
export function resolveJeepneyJackpotSpin(opts: {
  totalBet: number;
  isFreeSpins?: boolean;
  seed?: string;
}): SpinScript {
