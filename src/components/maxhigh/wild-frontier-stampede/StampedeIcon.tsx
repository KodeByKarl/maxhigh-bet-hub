/** Wild Frontier Stampede symbol tiles — wood-framed card art. */
import { memo } from "react";
import { cn } from "@/lib/utils";
import type { BuffaloSymKind } from "@/lib/buffalo-reign-config";

export const TILE_IMAGE_MAP: Record<BuffaloSymKind, string> = {
  sym_10: "/images/symbols/buffalo-reign/sym_10.png",
  sym_j: "/images/symbols/buffalo-reign/sym_j.png",
  sym_q: "/images/symbols/buffalo-reign/sym_q.png",
  sym_k: "/images/symbols/buffalo-reign/sym_k.png",
  sym_a: "/images/symbols/buffalo-reign/sym_a.png",
  lantern: "/images/symbols/buffalo-reign/lantern.png",
  wagon_wheel: "/images/symbols/buffalo-reign/wagon_wheel.png",
  campfire: "/images/symbols/buffalo-reign/campfire.png",
  elk: "/images/symbols/buffalo-reign/elk.png",
  mountain_lion: "/images/symbols/buffalo-reign/mountain_lion.png",
  eagle: "/images/symbols/buffalo-reign/eagle.png",
  grizzly: "/images/symbols/buffalo-reign/grizzly.png",
  bison: "/images/symbols/buffalo-reign/bison.png",
  wild: "/images/symbols/buffalo-reign/wild.png",
  scatter: "/images/symbols/buffalo-reign/scatter.png",
  bonus: "/images/symbols/buffalo-reign/bonus.png",
};
...
export const StampedeIcon = memo(function StampedeIcon({ kind, className, winning }: Props) {
  const isWild = kind === "wild";
  const isScatter = kind === "scatter";
  const isBonus = kind === "bonus";
  const src = TILE_IMAGE_MAP[kind] ?? TILE_IMAGE_MAP.sym_10;
