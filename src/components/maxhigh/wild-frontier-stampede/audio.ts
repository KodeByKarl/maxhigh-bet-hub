/**
 * Wild Frontier Stampede — wilderness / stampede SFX.
 * Assets from scripts/generate-buffalo-reign-sounds.mjs
 */
const BASE = "/sounds/buffalo-reign";
...
export const stampedeAudio = new StampedeAudio();
