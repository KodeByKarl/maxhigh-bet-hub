 ...
 */
import type { CrabCannonConfig, FishTierId } from "@/lib/crab-cannon-config";
import { getFishTier } from "@/lib/crab-cannon-config";
import { PATH_KINDS, SWIM, type SwimPathKind } from "./animationConfig";
import type { CrabCannonRng } from "./rng";
...
export function pickSpawnTier(cfg: CrabCannonConfig, rng: CrabCannonRng): FishTierId {
