 ...
 */
import type { PhoenixFisherConfig, FishTierId } from "@/lib/phoenix-fisher-config";
import { getFishTier } from "@/lib/phoenix-fisher-config";
import { PATH_KINDS, SWIM, type SwimPathKind } from "./animationConfig";
import type { PhoenixFisherRng } from "./rng";
...
export function pickSpawnTier(cfg: PhoenixFisherConfig, rng: PhoenixFisherRng): FishTierId {
