...
import { getLuckyNinePlusAnim, L9_ASSET } from "./animationConfig";
...
/** Lucky Nine Plus card — player sky / dealer lime rims (not Baccarat rose banker). */
export function CardCell({
  ...
  useEffect(() => {
    setFlipMs(getLuckyNinePlusAnim().flipDuration);
  }, []);
