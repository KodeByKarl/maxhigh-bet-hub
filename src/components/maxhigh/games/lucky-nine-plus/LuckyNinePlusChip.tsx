...
export function LuckyNinePlusChipFace({ value, className, size = 56 }: ChipFaceProps) {
...
/** Fat-finger chip button for Lucky Nine Plus dock. */
export function LuckyNinePlusChipButton({
  value,
  disabled,
  selected,
  onClick,
  ...
  return (
    ...
    >
      <LuckyNinePlusChipFace value={value} size={54} />
      {selected ? (
