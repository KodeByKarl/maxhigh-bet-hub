/**
 * Lucky Nine Plus deal resolver — pure math, no wallet I/O.
...
import { getLuckyNinePlusConfig } from "./runtimeConfig";

export type LuckyNinePlusOutcome = "player" | "dealer" | "tie";
...
export function resolveLuckyNinePlusDeal(opts: {
  playerBet?: number;
  dealerBet?: number;
  tieBet?: number;
  cfg?: LuckyNinePlusConfig;
  seed?: string;
  shoe?: ShoeState | null;
}): DealResolveResult {
  const cfg = opts.cfg ?? getLuckyNinePlusConfig();
