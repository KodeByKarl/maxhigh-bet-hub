...
export function freshShuffledShoe(cfg: TongitsArenaConfig, rng: TcpRng): ShoeState {
...
export function needsReshuffle(shoe: ShoeState, cfg: TongitsArenaConfig): boolean {
