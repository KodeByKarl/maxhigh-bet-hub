 ...
 */
import type { SharkHunterConfig, FishTierId } from "@/lib/shark-hunter-config";
import { getFishTier } from "@/lib/shark-hunter-config";
import { PATH_KINDS, SWIM, type SwimPathKind } from "./animationConfig";
import type { SharkHunterRng } from "./rng";
...
export function pickSpawnTier(cfg: SharkHunterConfig, rng: SharkHunterRng): FishTierId {
