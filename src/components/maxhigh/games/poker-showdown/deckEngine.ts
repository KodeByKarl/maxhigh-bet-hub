...
export function freshShuffledShoe(cfg: PokerShowdownConfig, rng: TcpRng): ShoeState {
...
export function needsReshuffle(shoe: ShoeState, cfg: PokerShowdownConfig): boolean {
