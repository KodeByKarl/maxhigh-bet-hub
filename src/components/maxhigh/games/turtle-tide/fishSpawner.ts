 ...
 */
import type { TurtleTideConfig, FishTierId } from "@/lib/turtle-tide-config";
import { getFishTier } from "@/lib/turtle-tide-config";
import { PATH_KINDS, SWIM, type SwimPathKind } from "./animationConfig";
import type { TurtleTideRng } from "./rng";
...
export function pickSpawnTier(cfg: TurtleTideConfig, rng: TurtleTideRng): FishTierId {
