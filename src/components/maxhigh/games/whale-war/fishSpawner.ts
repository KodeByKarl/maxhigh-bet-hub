 ...
 */
import type { WhaleWarConfig, FishTierId } from "@/lib/whale-war-config";
import { getFishTier } from "@/lib/whale-war-config";
import { PATH_KINDS, SWIM, type SwimPathKind } from "./animationConfig";
import type { WhaleWarRng } from "./rng";
...
export function pickSpawnTier(cfg: WhaleWarConfig, rng: WhaleWarRng): FishTierId {
