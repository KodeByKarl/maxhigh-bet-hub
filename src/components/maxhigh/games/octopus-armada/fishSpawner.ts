 ...
 */
import type { OctopusArmadaConfig, FishTierId } from "@/lib/octopus-armada-config";
...
export function pickSpawnTier(cfg: OctopusArmadaConfig, rng: OctopusArmadaRng): FishTierId {
