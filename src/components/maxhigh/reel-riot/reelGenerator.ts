import type { RrSymKind, ReelRiotConfig } from "@/lib/reel-riot-config";
...
function pickSymbol(rng: RrRng, cfg: ReelRiotConfig, reel: number): RrSymKind {
...
export function generateReels(rng: RrRng, cfg: ReelRiotConfig): RrReels {
