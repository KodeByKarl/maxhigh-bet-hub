...
import { getGodlyGatesConfig, getRuntimeSymbols } from "./runtimeConfig";
...
export const ICON_SRC: Record<SymKind, string> = {
  ten: "/images/symbols/godly-gates/ten.png",
  jack: "/images/symbols/godly-gates/jack.png",
  queen: "/images/symbols/godly-gates/queen.png",
  king: "/images/symbols/godly-gates/king.png",
  ace: "/images/symbols/godly-gates/ace.png",
  scarab: "/images/symbols/godly-gates/scarab.png",
  ankh: "/images/symbols/godly-gates/ankh.png",
  horus: "/images/symbols/godly-gates/horus.png",
  anubis: "/images/symbols/godly-gates/anubis.png",
  pharaoh: "/images/symbols/godly-gates/pharaoh.png",
  wild: "/images/symbols/godly-gates/wild.png",
  scatter: "/images/symbols/godly-gates/scatter.png",
};
...
export function scatterCashPay(count: number, bet: number): number {
  const tiers = [...getGodlyGatesConfig().scatterCashTiers].sort((a, b) => b.count - a.count);
...
export function getBuyFeatureMult() {
  return getGodlyGatesConfig().buyFeatureMult;
}

export function getFreeSpinsRetrigger() {
  return getGodlyGatesConfig().freeSpinsRetrigger;
}

export function getFsMultStart() {
  return getGodlyGatesConfig().fsMultStart;
}

export function getFsMultStep() {
  return getGodlyGatesConfig().fsMultStep;
}
...
export const ASSET = {
  backdrop: "/images/symbols/godly-gates/backdrop.webp?v=3",
  mascot: "/images/symbols/godly-gates/mascot-cut.webp?v=4",
} as const;
