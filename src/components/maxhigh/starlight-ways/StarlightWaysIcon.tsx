...
import type { StarlightWaysSymKind } from "@/lib/starlight-ways-config";

export const TILE_IMAGE_MAP: Record<StarlightWaysSymKind, string> = {
  sym_10: "/images/symbols/starlight-ways/10.png",
  sym_j: "/images/symbols/starlight-ways/j.png",
  sym_q: "/images/symbols/starlight-ways/q.png",
  sym_k: "/images/symbols/starlight-ways/k.png",
  sym_a: "/images/symbols/starlight-ways/a.png",
  moon: "/images/symbols/starlight-ways/moon.webp",
  star: "/images/symbols/starlight-ways/star.png",
  castle: "/images/symbols/starlight-ways/castle.webp",
  princess: "/images/symbols/starlight-ways/princess.png",
  comet: "/images/symbols/starlight-ways/comet.png",
  wild: "/images/symbols/starlight-ways/wild.webp",
  scatter: "/images/symbols/starlight-ways/scatter.webp",
};

type StarlightWaysIconProps = {
  kind: StarlightWaysSymKind;
  isGold?: boolean;
  className?: string;
};

/**
 * Symbol card glyph — generated tile art for Starlight Ways.
 */
export const StarlightWaysIcon = memo(function StarlightWaysIcon({
  kind,
  isGold,
  className,
}: StarlightWaysIconProps) {
