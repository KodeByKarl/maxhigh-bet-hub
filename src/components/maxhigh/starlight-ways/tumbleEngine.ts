import type { StarlightWaysSymbolConfig } from "@/lib/starlight-ways-config";
...
export function pickRandomSymbol(ante: boolean, isFreeSpins: boolean): StarlightWaysSymbolConfig {
