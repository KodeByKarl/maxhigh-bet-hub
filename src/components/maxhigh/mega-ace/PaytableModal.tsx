...
import { SYMBOL_NAMES, type MegaAceSymKind } from "@/lib/mega-ace-config";
import { getMegaAceConfig } from "./runtimeConfig";
import { MegaAceIcon } from "./MegaAceIcon";
...
const PAY_ORDER: MegaAceSymKind[] = [
  "ace_gold",
  "diamond",
  "club",
  "heart",
...
const HOWTO_IMG = {
  ways: "/images/mega-ace/howto/win-ways.png",
  threeCards: "/images/mega-ace/howto/win-three-cards.png",
  goldenJoker: "/images/mega-ace/howto/win-golden-joker.png",
  cascade: "/images/mega-ace/howto/win-cascade.png",
  freeSpins: "/images/mega-ace/howto/win-free-spins.png",
} as const;

function PatternStrip({ kinds, label }: { kinds: MegaAceSymKind[]; label: string }) {
  return (
