...
import type { MegaAceSymKind } from "@/lib/mega-ace-config";

export const TILE_IMAGE_MAP: Record<MegaAceSymKind, string> = {
  sym_j: "/images/symbols/mega-ace/j.png",
  sym_q: "/images/symbols/mega-ace/q.png",
  sym_k: "/images/symbols/mega-ace/k.png",
  sym_a: "/images/symbols/mega-ace/a.png",
  spade: "/images/symbols/mega-ace/spade.png",
  heart: "/images/symbols/mega-ace/heart.png",
  club: "/images/symbols/mega-ace/club.png",
  diamond: "/images/symbols/mega-ace/diamond.png",
  ace_gold: "/images/symbols/mega-ace/ace_gold.png",
  little_joker: "/images/symbols/mega-ace/little_joker.png",
  big_joker: "/images/symbols/mega-ace/big_joker.png",
  scatter: "/images/symbols/mega-ace/scatter.png",
};

type MegaAceIconProps = {
  kind: MegaAceSymKind;
  isGold?: boolean;
  className?: string;
};
...
/**
 * 3D Lucky Poker tile art � PNG symbols under /images/symbols/mega-ace/.
 */
export const MegaAceIcon = memo(function MegaAceIcon({
  kind,
  isGold,
  className,
}: MegaAceIconProps) {
