...
import { getNeonFruitsConfig } from "./runtimeConfig";
import { NeonFruitsIcon } from "./NeonFruitsIcon";
...
const HOWTO_IMG = {
  payline: "/images/neon-fruits/howto/win-payline.png",
  threeFruit: "/images/neon-fruits/howto/win-three-fruit.png",
  twoWild: "/images/neon-fruits/howto/win-two-wild.png",
  bonus: "/images/neon-fruits/howto/win-bonus-ladder.png",
} as const;
      ...
      <div className="flex items-center gap-1.5 rounded-2xl border border-white/25 bg-black/35 px-2 py-1.5">
        {kinds.map((k, i) => (
          <div key={`${k}-${i}`} className="size-11 shrink-0 sm:size-12">
            <NeonFruitsIcon kind={k} framed={false} />
          </div>
        ))}
      </div>
                ...
                return (
                  ...
                  >
                    <div className="size-12 shrink-0">
                      <NeonFruitsIcon kind={kind} framed={false} />
                    </div>
