import type { RrSymKind, NeonFruitsConfig } from "@/lib/neon-fruits-config";
...
function pickSymbol(rng: RrRng, cfg: NeonFruitsConfig, reel: number): RrSymKind {
...
export function generateReels(rng: RrRng, cfg: NeonFruitsConfig): RrReels {
