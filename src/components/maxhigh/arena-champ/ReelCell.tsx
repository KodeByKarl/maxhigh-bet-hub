...
import { ArenaChampIcon } from "./ArenaChampIcon";
...
/**
 * Arena Champ cell — CSS win ring with smooth fade-out (no hard cut).
 */
      ...
      {spinning ? (
        ...
        >
          {strip.map((sym, i) => (
            ...
            >
              <ArenaChampIcon kind={sym} framed />
            </div>
          ))}
        </div>
      ) : (
