import type { ManilaNightsSymbolConfig } from "@/lib/manila-nights-config";
...
export function pickRandomSymbol(ante: boolean, isFreeSpins: boolean): ManilaNightsSymbolConfig {
