...
import type { ManilaNightsSymKind } from "@/lib/manila-nights-config";

export const TILE_IMAGE_MAP: Record<ManilaNightsSymKind, string> = {
  sym_10: "/images/symbols/manila-nights/10.png",
  sym_j: "/images/symbols/manila-nights/j.png",
  sym_q: "/images/symbols/manila-nights/q.png",
  sym_k: "/images/symbols/manila-nights/k.png",
  sym_a: "/images/symbols/manila-nights/a.png",
  moon: "/images/symbols/manila-nights/moon.webp",
  star: "/images/symbols/manila-nights/star.png",
  castle: "/images/symbols/manila-nights/castle.webp",
  princess: "/images/symbols/manila-nights/princess.png",
  comet: "/images/symbols/manila-nights/comet.png",
  wild: "/images/symbols/manila-nights/wild.webp",
  scatter: "/images/symbols/manila-nights/scatter.webp",
};

type ManilaNightsIconProps = {
...
/**
 * Symbol card glyph — generated tile art for Manila Nights.
 */
export const ManilaNightsIcon = memo(function ManilaNightsIcon({
  kind,
  isGold,
  className,
}: ManilaNightsIconProps) {
