/**
 * Midnight Owl — quiet, ear-safe Web Audio kit.
 * Sine/triangle only, low-pass on every voice, low default volume.
 */

const MUTE_KEY = "midnight-owl-muted";
const VOL_KEY = "midnight-owl-volume";

const DEFAULT_VOLUME = 0.28;
const AMBIENT_BUS = 0.07;
const SFX_BUS = 0.18;

class MidnightOwlAudio {
...
export const midnightOwlAudio = new MidnightOwlAudio();
