...
import { clampBombMult } from "@/lib/midnight-owl-config";
...
/** Full glyph visible — contain only, never cover-crop (moon discs clip edges). */
export const PantherIcon = memo(function PantherIcon({
  ...
  const src = ICON_SRC[kind] || "/images/symbols/midnight-owl/10-cell.png?v=2";
