...
import { getMidnightOwlConfig } from "./runtimeConfig";
...
export function PaytableModal({ bet, onClose }: Props) {
  const cfg = getMidnightOwlConfig();
        ...
        >
          ...
          <div className="min-h-0 flex-1 space-y-3 overflow-y-auto px-4 py-3">
            <div className="rounded-xl bg-black/25 px-3 py-2 text-[11px] font-semibold leading-relaxed text-white/90">
              Symbols pay anywhere on the 5×4 moon board (20 cells).
              Land {minCluster} or more of the same symbol to win. Winning symbols
              tumble away and new ones drop in. {cfg.freeSpinsTriggerCount}+ lollipops
              trigger Free Spins. Bombs multiply the tumble win.
            </div>
