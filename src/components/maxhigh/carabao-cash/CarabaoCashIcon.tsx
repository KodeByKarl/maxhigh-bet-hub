/** Carabao Cash symbol tiles — wood-framed card art. */
import { memo } from "react";
import { cn } from "@/lib/utils";
import type { BuffaloSymKind } from "@/lib/carabao-cash-config";

export const CARABAO_TILE_IMAGE_MAP: Record<BuffaloSymKind, string> = {
  sym_10: "/images/symbols/carabao-cash/sym_10.png",
  sym_j: "/images/symbols/carabao-cash/sym_j.png",
  sym_q: "/images/symbols/carabao-cash/sym_q.png",
  sym_k: "/images/symbols/carabao-cash/sym_k.png",
  sym_a: "/images/symbols/carabao-cash/sym_a.png",
  lantern: "/images/symbols/carabao-cash/lantern.png",
  wagon_wheel: "/images/symbols/carabao-cash/wagon_wheel.png",
  campfire: "/images/symbols/carabao-cash/campfire.png",
  elk: "/images/symbols/carabao-cash/elk.png",
  mountain_lion: "/images/symbols/carabao-cash/mountain_lion.png",
  eagle: "/images/symbols/carabao-cash/eagle.png",
  grizzly: "/images/symbols/carabao-cash/grizzly.png",
  bison: "/images/symbols/carabao-cash/bison.png",
  wild: "/images/symbols/carabao-cash/wild.png",
  scatter: "/images/symbols/carabao-cash/scatter.png",
  bonus: "/images/symbols/carabao-cash/bonus.png",
};
...
export const CarabaoCashIcon = memo(function CarabaoCashIcon({ kind, className, winning }: Props) {
