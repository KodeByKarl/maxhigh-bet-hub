/**
 * Carabao Cash � carabao / vault SFX.
 * Assets from scripts/generate-carabao-cash-sounds.mjs
 */
const BASE = "/sounds/carabao-cash";
...
export const carabaoCashAudio = new CarabaoCashAudio();
