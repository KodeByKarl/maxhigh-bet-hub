/**
 * Lantern Luck — themed SFX (firecrackers, gongs, pentatonic luck).
 * Assets from scripts/generate-lantern-luck-sounds.mjs
 */
const BASE = "/sounds/lantern-luck";
...
export const lanternLuckAudio = new LanternLuckAudio();
