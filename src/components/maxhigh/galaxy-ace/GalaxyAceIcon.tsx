...
import type { GalaxyAceSymKind } from "@/lib/galaxy-ace-config";

export const TILE_IMAGE_MAP: Record<GalaxyAceSymKind, string> = {
  sym_10: "/images/symbols/galaxy-ace/10.png",
  sym_j: "/images/symbols/galaxy-ace/j.png",
  sym_q: "/images/symbols/galaxy-ace/q.png",
  sym_k: "/images/symbols/galaxy-ace/k.png",
  sym_a: "/images/symbols/galaxy-ace/a.png",
  moon: "/images/symbols/galaxy-ace/moon.webp",
  star: "/images/symbols/galaxy-ace/star.png",
  castle: "/images/symbols/galaxy-ace/castle.webp",
  princess: "/images/symbols/galaxy-ace/princess.png",
  comet: "/images/symbols/galaxy-ace/comet.png",
  wild: "/images/symbols/galaxy-ace/wild.webp",
  scatter: "/images/symbols/galaxy-ace/scatter.webp",
};

type GalaxyAceIconProps = {
...
/**
 * Symbol card glyph — generated tile art for Galaxy Ace.
 */
export const GalaxyAceIcon = memo(function GalaxyAceIcon({
  kind,
  isGold,
  className,
}: GalaxyAceIconProps) {
