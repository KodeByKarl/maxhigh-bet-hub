...
import { SYMBOL_NAMES, type GalaxyAceSymKind } from "@/lib/galaxy-ace-config";
import { getGalaxyAceConfig } from "./runtimeConfig";
import { GalaxyAceIcon } from "./GalaxyAceIcon";
      ...
      >
        ...
        >
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-lg font-black text-[#F5D76E]">Galaxy Ace · Info</h2>
            <button
              type="button"
              onClick={onClose}
