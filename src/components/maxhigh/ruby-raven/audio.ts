/**
 * Ruby Raven — quiet, ear-safe Web Audio kit.
 * Sine/triangle only, low-pass on every voice, low default volume.
 */

const MUTE_KEY = "ruby-raven-muted";
const VOL_KEY = "ruby-raven-volume";

const DEFAULT_VOLUME = 0.28;
const AMBIENT_BUS = 0.07;
const SFX_BUS = 0.18;

class RubyRavenAudio {
...
export const rubyRavenAudio = new RubyRavenAudio();
