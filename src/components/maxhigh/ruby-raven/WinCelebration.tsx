...
/** Ruby Raven win overlay — crimson gem / rose. */
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {Array.from({ length: sparkCount }).map((_, i) => (
          <motion.div
            ...
            style={{
              color: i % 2 === 0 ? "#FB7185" : "#FECDD3",
              filter:
                i % 2 === 0
                  ? "drop-shadow(0 0 10px rgba(244,63,94,0.9))"
                  : "drop-shadow(0 0 10px rgba(254,205,211,0.85))",
            }}
          >
            {i % 3 === 0 ? "✦" : i % 3 === 1 ? "◆" : "✧"}
          </motion.div>
      ...
      >
            ...
            ch === " " ? (
              ...
              <motion.span
                ...
                style={{
                  ...
                  WebkitTextStroke: "0.1em #881337",
                  paintOrder: "stroke fill",
                  textShadow:
                    "0 0.08em 0 #9F1239, 0 0.16em 0.22em rgba(0,0,0,0.45)",
                }}
              >
                {ch}
              </motion.span>
        ...
        {showMultPanel ? (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, #FFE4E6 0%, #F43F5E 45%, #881337 100%)",
        ...
        {showMultPanel && shownMult > 1 ? (
          <motion.div
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, rgba(136,19,55,0.96), rgba(15,4,8,0.98))",
          ...
          >
            <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-end gap-1 text-white">
              <div className="min-w-0 text-center">
                ...
                <div className="truncate font-black tabular-nums text-base text-[#FECDD3] sm:text-lg">
                  ₱{shownEarn.toFixed(2)}
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-rose-100/60">×</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-pink-200/90">
                  Multiplier
                </div>
                <div className="font-black tabular-nums text-base text-[#FDA4AF] sm:text-lg">
                  {shownMult}x
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-rose-100/60">=</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-rose-100/90">
                  Total
                </div>
                <div className="truncate font-black tabular-nums text-base text-[#FECDD3] sm:text-lg">
                  ₱{amount.toFixed(2)}
        ...
        <div className="relative z-[1] w-full px-1">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #FFF1F2 0%, #FDA4AF 22%, #E11D48 55%, #881337 100%)",
              boxShadow:
                "0 10px 32px rgba(225,29,72,0.55), inset 0 3px 10px rgba(255,255,255,0.45), inset 0 -4px 10px rgba(136,19,55,0.35)",
              border: "4px solid rgba(255,228,230,0.85)",
            }}
          >
            <div
              className="relative text-center text-[10px] font-black uppercase tracking-[0.18em]"
              style={{ color: "rgba(255,241,242,0.95)" }}
            >
              Total Win
            </div>
            <motion.div
              ...
              style={{
                ...
                color: "#FFF1F2",
                textShadow: "0 3px 0 #881337, 0 7px 16px rgba(15,4,8,0.55)",
                WebkitTextStroke: "1.5px rgba(136,19,55,0.45)",
              }}
            >
              ₱{amount.toFixed(2)}
            </motion.div>
        ...
        <div
          ...
          style={{ color: "rgba(255,228,230,0.85)" }}
        >
          Tap to continue
        </div>
      </motion.div>
