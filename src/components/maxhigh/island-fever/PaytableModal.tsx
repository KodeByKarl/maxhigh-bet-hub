...
import { IslandFeverIcon } from "./IslandFeverIcon";
          ...
          <div className="min-h-0 flex-1 space-y-3 overflow-y-auto px-4 py-3">
            ...
            <div className="grid gap-2">
              {pays.map((sym) => (
                ...
                >
                  <IslandFeverIcon kind={sym.kind} className="size-10 shrink-0" />
            ...
            <div className="flex items-center gap-3 rounded-xl border border-white/15 bg-white/10 px-2.5 py-2">
              <IslandFeverIcon kind="lollipop" className="size-10 shrink-0" />
            ...
            <div className="flex items-center gap-3 rounded-xl border border-white/15 bg-white/10 px-2.5 py-2">
              <IslandFeverIcon kind="bomb" mult={2} className="size-10 shrink-0" />
              <div className="text-[11px] font-bold leading-snug text-white">
