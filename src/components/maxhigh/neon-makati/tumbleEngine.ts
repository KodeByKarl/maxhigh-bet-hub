import type { NeonMakatiSymbolConfig } from "@/lib/neon-makati-config";
...
export function pickRandomSymbol(ante: boolean, isFreeSpins: boolean): NeonMakatiSymbolConfig {
  const config = getNeonMakatiConfig();
  let total = 0;
