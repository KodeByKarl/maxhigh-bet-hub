...
import { SYMBOL_NAMES, type NeonMakatiSymKind } from "@/lib/neon-makati-config";
import { getNeonMakatiConfig } from "./runtimeConfig";
import { NeonMakatiIcon } from "./NeonMakatiIcon";
      ...
      >
        ...
        >
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-lg font-black text-[#F5D76E]">Neon Makati · Info</h2>
            <button
              type="button"
              onClick={onClose}
