...
export const TILE_IMAGE_MAP: Record<FgSymKind, string> = {
  sym_j: "/images/symbols/dust-dollars/j.png",
  sym_q: "/images/symbols/dust-dollars/q.png",
  sym_k: "/images/symbols/dust-dollars/k.png",
  sym_a: "/images/symbols/dust-dollars/a.png",
  sheriff: "/images/symbols/dust-dollars/sheriff.png",
  bartender: "/images/symbols/dust-dollars/bartender.png",
  banker: "/images/symbols/dust-dollars/banker.png",
  bandit: "/images/symbols/dust-dollars/bandit.png",
  safe: "/images/symbols/dust-dollars/safe.png",
  wild: "/images/symbols/dust-dollars/wild.png",
  scatter: "/images/symbols/dust-dollars/scatter.png",
  bonus: "/images/symbols/dust-dollars/bonus.png",
};

type Props = { kind: FgSymKind; className?: string; coinLabel?: string };

/**
 * Dust & Dollars symbol — square PNG art clipped to a circle (matches Pug Den cells).
 */
export const DustDollarsIcon = memo(function DustDollarsIcon({ kind, className, coinLabel }: Props) {
