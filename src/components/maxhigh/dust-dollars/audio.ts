/**
 * Dust & Dollars — western Hold & Win SFX.
 * Assets from scripts/generate-dust-dollars-sounds.mjs
 */
const BASE = "/sounds/dust-dollars";
...
export const dustDollarsAudio = new DustDollarsAudio();
