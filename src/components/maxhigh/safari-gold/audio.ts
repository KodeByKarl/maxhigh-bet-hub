/**
 * Safari Gold � carabao / vault SFX.
 * Assets from scripts/generate-safari-gold-sounds.mjs
 */
const BASE = "/sounds/safari-gold";
...
export const safariGoldAudio = new SafariGoldAudio();
