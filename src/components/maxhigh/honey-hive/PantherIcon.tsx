...
import { clampBombMult } from "@/lib/honey-hive-config";
...
/** Full glyph visible — contain only, never cover-crop (hex cells clip edges). */
export const PantherIcon = memo(function PantherIcon({
  ...
  const src = ICON_SRC[kind] || "/images/symbols/honey-hive/10-cell.png?v=2";
