...
/** Pointy-top hex — soft enough that padded icons stay fully visible. */
const HEX_CLIP =
  "polygon(50% 2%, 96% 26%, 96% 74%, 50% 98%, 4% 74%, 4% 26%)";
...
/** Honeycomb hex cell — amber wax tile. */
export const ReelCell = memo(function ReelCell({
  ...
  return (
    <div
      className={cn(
        "relative aspect-square w-full overflow-hidden isolate",
        "border-2 bg-[#1a0e04]/95 shadow-[0_4px_14px_rgba(0,0,0,0.4),inset_0_0_14px_rgba(245,158,11,0.14)]",
      ...
      style={{
        ...
        boxShadow: isWinLit
          ? "0 0 18px var(--p-spin-shadow), inset 0 0 14px rgba(251,191,36,0.35)"
          : undefined,
      }}
    >
      {cell && (
