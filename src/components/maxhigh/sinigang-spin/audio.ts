/**
 * Sinigang Spin — themed SFX (firecrackers, gongs, pentatonic luck).
 * Assets from scripts/generate-sinigang-spin-sounds.mjs
 */
const BASE = "/sounds/sinigang-spin";
...
export const sinigangSpinAudio = new SinigangSpinAudio();
