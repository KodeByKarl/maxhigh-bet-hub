...
/**
 * 3D symbol glyph — transparent PNGs under /images/symbols/sinigang-spin/.
 * Sized large for readability (older players).
 */
export const SinigangSpinIcon = memo(function SinigangSpinIcon({
  kind,
  className,
  extraLabel,
}: SinigangSpinIconProps) {
