...
import { SYMBOL_NAMES, type CnySymKind } from "@/lib/sinigang-spin-config";
import { getSinigangSpinConfig } from "./runtimeConfig";
import { SinigangSpinIcon } from "./SinigangSpinIcon";
    ...
    <div className="absolute inset-0 z-50 grid place-items-center bg-black/70 p-4">
      <div className="max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-yellow-600/50 bg-gradient-to-b from-red-950 to-stone-950 p-4 shadow-2xl">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-black text-yellow-200">Sinigang Spin · Info</h2>
          <button
            type="button"
            onClick={onClose}
