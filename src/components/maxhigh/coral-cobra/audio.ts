/**
 * Coral Cobra — quiet, ear-safe Web Audio kit.
 * Sine/triangle only, low-pass on every voice, low default volume.
 */

const MUTE_KEY = "coral-cobra-muted";
const VOL_KEY = "coral-cobra-volume";

const DEFAULT_VOLUME = 0.28;
const AMBIENT_BUS = 0.07;
const SFX_BUS = 0.18;

class CoralCobraAudio {
...
export const coralCobraAudio = new CoralCobraAudio();
