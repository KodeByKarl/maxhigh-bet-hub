/**
 * Diamond Dig Dig — western Hold & Win SFX.
 * Assets from scripts/generate-diamond-dig-sounds.mjs
 */
const BASE = "/sounds/diamond-dig";
...
export const diamondDigAudio = new DiamondDigAudio();
