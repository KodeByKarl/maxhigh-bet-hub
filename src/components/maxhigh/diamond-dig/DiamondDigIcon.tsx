...
export const TILE_IMAGE_MAP: Record<FgSymKind, string> = {
  sym_j: "/images/symbols/diamond-dig/j.png",
  sym_q: "/images/symbols/diamond-dig/q.png",
  sym_k: "/images/symbols/diamond-dig/k.png",
  sym_a: "/images/symbols/diamond-dig/a.png",
  sheriff: "/images/symbols/diamond-dig/sheriff.png",
  bartender: "/images/symbols/diamond-dig/bartender.png",
  banker: "/images/symbols/diamond-dig/banker.png",
  bandit: "/images/symbols/diamond-dig/bandit.png",
  safe: "/images/symbols/diamond-dig/safe.png",
  wild: "/images/symbols/diamond-dig/wild.png",
  scatter: "/images/symbols/diamond-dig/scatter.png",
  bonus: "/images/symbols/diamond-dig/bonus.png",
};

type Props = { kind: FgSymKind; className?: string; coinLabel?: string };

/**
 * Diamond Dig Dig symbol — square PNG art clipped to a circle (matches Pug Den cells).
 */
export const DiamondDigIcon = memo(function DiamondDigIcon({ kind, className, coinLabel }: Props) {
