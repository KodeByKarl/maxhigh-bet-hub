...
/** Ember Tiger letter accents — orange fire + amber gold. */
const LETTER_COLORS = [
  "#FED7AA",
  "#FB923C",
  "#FDBA74",
...
/** Ember Tiger win overlay — fire orange / amber, theme-aligned. */
      ...
      >
            ...
            ch === " " ? (
              ...
              <motion.span
                ...
                style={{
                  ...
                  WebkitTextStroke: "0.1em #7C2D12",
                  paintOrder: "stroke fill",
                  textShadow:
                    "0 0.08em 0 #9A3412, 0 0.16em 0.22em rgba(0,0,0,0.45)",
                }}
              >
                {ch}
              </motion.span>
        ...
        {showMultPanel ? (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, #FED7AA 0%, #EA580C 45%, #B91C1C 100%)",
          ...
          >
            <div
              ...
              style={{
                ...
                background: "linear-gradient(180deg, #9A3412 0%, #450A0A 100%)",
              }}
            >
              <div
              ...
              <div
                ...
                style={{
                  ...
                  color: "#FBBF24",
                  textShadow: "0 3px 0 #7C2D12, 0 6px 10px rgba(0,0,0,0.45)",
              ...
              {!formulaMatches && bankedMult > 1 ? (
                <div className="mt-1 text-[9px] font-bold uppercase tracking-wide text-orange-100/85">
        ...
        {showMultPanel && shownMult > 1 ? (
          <motion.div
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, rgba(124,45,18,0.96), rgba(69,10,10,0.98))",
              boxShadow: "0 10px 28px rgba(0,0,0,0.4)",
            }}
          >
            <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-end gap-1 text-white">
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-orange-200/90">
                  Total Earn
                </div>
                <div className="truncate font-black tabular-nums text-base text-[#FDBA74] sm:text-lg">
                  ₱{shownEarn.toFixed(2)}
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-orange-100/60">×</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-amber-200/90">
                  Multiplier
                </div>
                <div className="font-black tabular-nums text-base text-[#FBBF24] sm:text-lg">
                  {shownMult}x
                </div>
              </div>
              <div className="pb-0.5 text-xl font-black text-orange-100/60">=</div>
              <div className="min-w-0 text-center">
                <div className="text-[8px] font-black uppercase tracking-wider text-orange-100/90">
                  Total
                </div>
                <div className="truncate font-black tabular-nums text-base text-[#FDBA74] sm:text-lg">
                  ₱{amount.toFixed(2)}
        ...
        <div className="relative z-[1] w-full px-1">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #FED7AA 0%, #FB923C 22%, #EA580C 55%, #B91C1C 100%)",
              boxShadow:
                "0 10px 32px rgba(234,88,12,0.55), inset 0 3px 10px rgba(255,255,255,0.35), inset 0 -4px 10px rgba(69,10,10,0.35)",
              border: "4px solid rgba(253,186,116,0.8)",
            }}
          >
            <div
              className="relative text-center text-[10px] font-black uppercase tracking-[0.18em]"
              style={{ color: "rgba(255,237,213,0.92)" }}
            >
              Total Win
            </div>
            <motion.div
              ...
              style={{
                ...
                color: "#FFF7ED",
                textShadow: "0 3px 0 #7C2D12, 0 7px 16px rgba(69,10,10,0.55)",
                WebkitTextStroke: "1.5px rgba(124,45,18,0.45)",
              }}
            >
              ₱{amount.toFixed(2)}
            </motion.div>
        ...
        <div
          ...
          style={{ color: "rgba(254,215,170,0.85)" }}
        >
          Tap to continue
        </div>
      </motion.div>
