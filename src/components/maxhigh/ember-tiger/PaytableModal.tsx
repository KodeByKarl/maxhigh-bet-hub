...
import { getEmberTigerConfig } from "./runtimeConfig";
        ...
        >
          ...
          <div className="min-h-0 flex-1 space-y-3 overflow-y-auto px-4 py-3">
            <div className="rounded-xl bg-black/25 px-3 py-2 text-[11px] font-semibold leading-relaxed text-white/90">
              Symbols pay anywhere on the diamond (3-4-5-4-3). Land {minCluster} or more of the
            ...
            <div className="grid gap-2">
              {pays.map((sym) => (
                ...
                >
                  <PantherIcon kind={sym.kind} fit="contain" className="size-10 shrink-0 overflow-hidden rounded-full" />
            ...
            <div className="flex items-center gap-3 rounded-xl border border-white/15 bg-white/10 px-2.5 py-2">
              <PantherIcon kind="lollipop" fit="contain" className="size-10 shrink-0 overflow-hidden rounded-full" />
            ...
            <div className="flex items-center gap-3 rounded-xl border border-white/15 bg-white/10 px-2.5 py-2">
              <PantherIcon kind="bomb" mult={2} fit="contain" className="size-10 shrink-0 overflow-hidden rounded-full" />
              <div className="text-[11px] font-bold leading-snug text-white">
