/**
 * Wild Panther — Web Audio Sound Engine & Theme Music Synthesizer.
 * Commercial-safe, procedural Web Audio synthesized sounds and jungle ambient beat.
 */

const MUTE_KEY = "wild-panther-muted";
const VOL_KEY = "wild-panther-volume";

class WildPantherAudio {
  ...
  /**
   * Wild Panther Scatter Trigger Stinger (Roar + Majestic Chimes).
   */
  playScatterTrigger() {
    this.stopSpinLoop();
    const ctx = this.ensureCtx();
...
export const pantherAudio = new WildPantherAudio();
