 ...
 */
export const WildPantherIcon = memo(function WildPantherIcon({
  kind,
  mult,
  className,
}: WildPantherIconProps) {
  const isScatter = kind === "lollipop";
  const isBomb = kind === "bomb";
  const src = ICON_SRC[kind] || "/images/symbols/wild-panther/10.png?v=1";
