/**
 * Palengke Pays — western Hold & Win SFX.
 * Assets from scripts/generate-palengke-pays-sounds.mjs
 */
const BASE = "/sounds/palengke-pays";
...
export const palengkePaysAudio = new PalengkePaysAudio();
