import type { StarlightSymbolConfig } from "@/lib/starlight-ace-config";
...
export function pickRandomSymbol(ante: boolean, isFreeSpins: boolean): StarlightSymbolConfig {
  const config = getStarlightAceConfig();
  let total = 0;
