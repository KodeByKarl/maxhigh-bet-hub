...
import type { WildAceSymKind } from "@/lib/wild-ace-config";

export const TILE_IMAGE_MAP: Record<WildAceSymKind, string> = {
  sym_j: "/images/symbols/wild-ace/j.png",
  sym_q: "/images/symbols/wild-ace/q.png",
  sym_k: "/images/symbols/wild-ace/k.png",
  sym_a: "/images/symbols/wild-ace/a.png",
  spade: "/images/symbols/wild-ace/spade.png",
  heart: "/images/symbols/wild-ace/heart.png",
  club: "/images/symbols/wild-ace/club.png",
  diamond: "/images/symbols/wild-ace/diamond.png",
  ace_gold: "/images/symbols/wild-ace/ace_gold.png",
  little_joker: "/images/symbols/wild-ace/little_joker.png",
  big_joker: "/images/symbols/wild-ace/big_joker.png",
  scatter: "/images/symbols/wild-ace/scatter.png",
};

type WildAceIconProps = {
  kind: WildAceSymKind;
  isGold?: boolean;
  className?: string;
};
...
/**
 * 3D Lucky Poker tile art � PNG symbols under /images/symbols/wild-ace/.
 */
export const WildAceIcon = memo(function WildAceIcon({
  kind,
  isGold,
  className,
}: WildAceIconProps) {
