/**
 * Aztec Treasure — Web Audio Sound Engine & Theme Music Synthesizer.
 * Commercial-safe, procedural Web Audio synthesized sounds and jungle ambient beat.
 */

const MUTE_KEY = "aztec-treasure-muted";
const VOL_KEY = "aztec-treasure-volume";

class AztecTreasureAudio {
  ...
  /**
   * Aztec Treasure Scatter Trigger Stinger (Roar + Majestic Chimes).
   */
  playScatterTrigger() {
    this.stopSpinLoop();
    const ctx = this.ensureCtx();
...
export const pantherAudio = new AztecTreasureAudio();
