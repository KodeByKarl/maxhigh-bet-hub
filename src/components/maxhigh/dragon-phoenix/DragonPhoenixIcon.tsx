...
import type { DragonPhoenixSymKind } from "@/lib/dragon-phoenix-config";

export const TILE_IMAGE_MAP: Record<DragonPhoenixSymKind, string> = {
 ...
 */
export const DragonPhoenixIcon = memo(function DragonPhoenixIcon({
  kind,
  isGold,
  className,
}: DragonPhoenixIconProps) {
