...
export const ICON_SRC: Record<BkSymKind, string> = {
  bar: "/images/symbols/knockout-king/bar.webp",
  dice: "/images/symbols/knockout-king/dice.webp",
  diamond: "/images/symbols/knockout-king/diamond.webp",
  chip: "/images/symbols/knockout-king/chip.webp",
  lucky7: "/images/symbols/knockout-king/lucky7.webp",
  wild: "/images/symbols/knockout-king/wild.webp",
  scatter: "/images/symbols/knockout-king/scatter.webp",
};

/** Ornate metal frame overlay (Frontier-style card border, fire palette). */
export const CARD_FRAME_SRC = "/images/symbols/knockout-king/card-frame.png";
