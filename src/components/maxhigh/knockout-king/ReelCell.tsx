...
import { KnockoutKingIcon } from "./KnockoutKingIcon";
...
/**
 * Knockout King cell — CSS win ring with smooth fade-out (no hard cut).
 */
      ...
      {spinning ? (
        ...
        >
          {strip.map((sym, i) => (
            ...
            >
              <KnockoutKingIcon kind={sym} framed />
            </div>
          ))}
        </div>
      ) : (
