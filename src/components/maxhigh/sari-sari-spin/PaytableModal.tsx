...
import { SariSariSpinIcon } from "./SariSariSpinIcon";
import { getSariSariSpinConfig } from "./runtimeConfig";
              ...
              return (
                ...
                >
                  <div className="size-11 shrink-0 sm:size-12">
                    <SariSariSpinIcon kind={kind} framed={false} />
                  </div>
