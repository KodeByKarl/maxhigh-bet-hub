/** Carabao Charge symbol tiles — wood-framed card art. */
import { memo } from "react";
import { cn } from "@/lib/utils";
import type { BuffaloSymKind } from "@/lib/carabao-charge-config";

export const CARABAO_TILE_IMAGE_MAP: Record<BuffaloSymKind, string> = {
  sym_10: "/images/symbols/carabao-charge/sym_10.png",
  sym_j: "/images/symbols/carabao-charge/sym_j.png",
  sym_q: "/images/symbols/carabao-charge/sym_q.png",
  sym_k: "/images/symbols/carabao-charge/sym_k.png",
  sym_a: "/images/symbols/carabao-charge/sym_a.png",
  lantern: "/images/symbols/carabao-charge/lantern.png",
  wagon_wheel: "/images/symbols/carabao-charge/wagon_wheel.png",
  campfire: "/images/symbols/carabao-charge/campfire.png",
  elk: "/images/symbols/carabao-charge/elk.png",
  mountain_lion: "/images/symbols/carabao-charge/mountain_lion.png",
  eagle: "/images/symbols/carabao-charge/eagle.png",
  grizzly: "/images/symbols/carabao-charge/grizzly.png",
  bison: "/images/symbols/carabao-charge/bison.png",
  wild: "/images/symbols/carabao-charge/wild.png",
  scatter: "/images/symbols/carabao-charge/scatter.png",
  bonus: "/images/symbols/carabao-charge/bonus.png",
};
...
export const CarabaoChargeIcon = memo(function CarabaoChargeIcon({ kind, className, winning }: Props) {
