/**
 * Carabao Charge � carabao / vault SFX.
 * Assets from scripts/generate-carabao-charge-sounds.mjs
 */
const BASE = "/sounds/carabao-charge";
...
export const carabaoChargeAudio = new CarabaoChargeAudio();
