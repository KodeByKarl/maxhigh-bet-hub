/**
 * Desert Riches — western Hold & Win SFX.
 * Assets from scripts/generate-desert-riches-sounds.mjs
 */
const BASE = "/sounds/desert-riches";
...
export const desertRichesAudio = new DesertRichesAudio();
