...
export const TILE_IMAGE_MAP: Record<FgSymKind, string> = {
  sym_j: "/images/symbols/desert-riches/j.png",
  sym_q: "/images/symbols/desert-riches/q.png",
  sym_k: "/images/symbols/desert-riches/k.png",
  sym_a: "/images/symbols/desert-riches/a.png",
  sheriff: "/images/symbols/desert-riches/sheriff.png",
  bartender: "/images/symbols/desert-riches/bartender.png",
  banker: "/images/symbols/desert-riches/banker.png",
  bandit: "/images/symbols/desert-riches/bandit.png",
  safe: "/images/symbols/desert-riches/safe.png",
  wild: "/images/symbols/desert-riches/wild.png",
  scatter: "/images/symbols/desert-riches/scatter.png",
  bonus: "/images/symbols/desert-riches/bonus.png",
};

type Props = { kind: FgSymKind; className?: string; coinLabel?: string };

/**
 * Desert Riches symbol — square PNG art clipped to a circle (matches Pug Den cells).
 */
export const DesertRichesIcon = memo(function DesertRichesIcon({ kind, className, coinLabel }: Props) {
