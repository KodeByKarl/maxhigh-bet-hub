...
import { FortuneGemsIcon } from "./FortuneGemsIcon";
import { getFortuneGemsConfig } from "./runtimeConfig";
              ...
              return (
                ...
                >
                  <div className="size-11 shrink-0 sm:size-12">
                    <FortuneGemsIcon kind={kind} framed={false} />
                  </div>
