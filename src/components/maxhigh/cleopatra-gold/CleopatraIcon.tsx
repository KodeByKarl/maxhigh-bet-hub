/** Cleopatra Gold symbol tiles — wood-framed card art. */
import { memo } from "react";
import { cn } from "@/lib/utils";
import type { BuffaloSymKind } from "@/lib/cleopatra-gold-config";

export const CLEO_TILE_IMAGE_MAP: Record<BuffaloSymKind, string> = {
  sym_10: "/images/symbols/cleopatra-gold/sym_10.png",
  sym_j: "/images/symbols/cleopatra-gold/sym_j.png",
  sym_q: "/images/symbols/cleopatra-gold/sym_q.png",
  sym_k: "/images/symbols/cleopatra-gold/sym_k.png",
  sym_a: "/images/symbols/cleopatra-gold/sym_a.png",
  lantern: "/images/symbols/cleopatra-gold/lantern.png",
  wagon_wheel: "/images/symbols/cleopatra-gold/wagon_wheel.png",
  campfire: "/images/symbols/cleopatra-gold/campfire.png",
  elk: "/images/symbols/cleopatra-gold/elk.png",
  mountain_lion: "/images/symbols/cleopatra-gold/mountain_lion.png",
  eagle: "/images/symbols/cleopatra-gold/eagle.png",
  grizzly: "/images/symbols/cleopatra-gold/grizzly.png",
  bison: "/images/symbols/cleopatra-gold/bison.png",
  wild: "/images/symbols/cleopatra-gold/wild.png",
  scatter: "/images/symbols/cleopatra-gold/scatter.png",
  bonus: "/images/symbols/cleopatra-gold/bonus.png",
};
...
export const CleopatraIcon = memo(function CleopatraIcon({ kind, className, winning }: Props) {
  const isWild = kind === "wild";
  const isScatter = kind === "scatter";
  const isBonus = kind === "bonus";
  const src = CLEO_TILE_IMAGE_MAP[kind] ?? CLEO_TILE_IMAGE_MAP.sym_10;
