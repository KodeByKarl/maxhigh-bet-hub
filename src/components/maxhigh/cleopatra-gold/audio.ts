/**
 * Cleopatra Gold � Egyptian / vault SFX.
 * Assets from scripts/generate-cleopatra-gold-sounds.mjs
 */
const BASE = "/sounds/cleopatra-gold";
...
export const cleopatraAudio = new CleopatraGoldAudio();
