...
export const PERMISSION_MAP: Record<PermissionName, UserRole[]> = {
  ...
  USER_ADJUST_BALANCE: ["admin", "superadmin"],
  USER_LOCK: ["admin", "superadmin"],
  USER_UNLOCK: ["admin", "superadmin"],
  USER_FORCE_LOGOUT: ["admin", "superadmin"],
  USER_RESET_FAILED: ["admin", "superadmin"],
  WALLET_LIST: ["admin", "superadmin", "agent", "master_agent"],
  WALLET_REVIEW: ["admin", "superadmin"],
  SUPPORT_MANAGE: ["admin", "superadmin", "agent"],
  AUDIT_LOG_VIEW: ["admin", "superadmin"],
  TRANSACTION_LIST: ["admin", "superadmin"],
  REPORTS_VIEW: ["admin", "superadmin"],
