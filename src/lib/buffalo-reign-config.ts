/**
 * Buffalo Reign (catalog id: buffalo-reign) — math & configuration.
 * 5×4 ways (1,024), cascade multipliers, Golden Campfire free spins,
 * Treasure Chest Hold & Collect, Explorer→Legend jackpots.
 */

export const BUFFALO_REIGN_GAME_ID = "buffalo-reign";
export const BUFFALO_REIGN_TITLE = "Buffalo Reign";
...
export type BuffaloReignConfig = {
  schemaVersion: 1;
  reelsCount: number;
...
export const DEFAULT_BUFFALO_REIGN_CONFIG: BuffaloReignConfig = {
  schemaVersion: 1,
  reelsCount: 5,
  minReelHeight: 4,
  maxReelHeight: 4,
  ...
  freeSpinsCascadeMultipliers: [2, 3, 4, 6, 8],
  freeSpinsSessionMultStart: 1,
  freeSpinsSessionMultStep: 0.5,
  ...
  volatility: "High",
  symbols: [
    { id: "sym_10", kind: "sym_10", name: "10", tier: "low", weight: 130, weightFreeSpins: 100, pay: [0.077, 0.208, 0.53] },
    { id: "sym_j", kind: "sym_j", name: "J", tier: "low", weight: 120, weightFreeSpins: 95, pay: [0.097, 0.26, 0.645] },
    { id: "sym_q", kind: "sym_q", name: "Q", tier: "low", weight: 110, weightFreeSpins: 90, pay: [0.119, 0.322, 0.811] },
    { id: "sym_k", kind: "sym_k", name: "K", tier: "low", weight: 95, weightFreeSpins: 80, pay: [0.151, 0.395, 0.967] },
    { id: "sym_a", kind: "sym_a", name: "A", tier: "low", weight: 85, weightFreeSpins: 75, pay: [0.188, 0.489, 1.196] },
    { id: "lantern", kind: "lantern", name: "Lantern", tier: "medium", weight: 60, weightFreeSpins: 55, pay: [0.298, 0.759, 1.882] },
    { id: "wagon_wheel", kind: "wagon_wheel", name: "Wagon Wheel", tier: "medium", weight: 50, weightFreeSpins: 48, pay: [0.379, 0.967, 2.444] },
    { id: "campfire", kind: "campfire", name: "Campfire", tier: "medium", weight: 42, weightFreeSpins: 40, pay: [0.487, 1.196, 2.964] },
    { id: "elk", kind: "elk", name: "Elk", tier: "premium", weight: 32, weightFreeSpins: 30, pay: [0.645, 1.622, 4.056] },
    { id: "mountain_lion", kind: "mountain_lion", name: "Mountain Lion", tier: "premium", weight: 26, weightFreeSpins: 26, pay: [0.863, 2.163, 5.408] },
    { id: "eagle", kind: "eagle", name: "Bald Eagle", tier: "premium", weight: 20, weightFreeSpins: 22, pay: [1.196, 2.964, 7.571] },
    { id: "grizzly", kind: "grizzly", name: "Grizzly Bear", tier: "premium", weight: 14, weightFreeSpins: 16, pay: [1.622, 4.056, 10.275] },
    { id: "bison", kind: "bison", name: "Bison", tier: "premium", weight: 10, weightFreeSpins: 12, pay: [2.163, 5.408, 13.541] },
    ...
    { id: "bonus", kind: "bonus", name: "Treasure Chest", tier: "bonus", weight: 18, weightFreeSpins: 0, pay: [0, 0, 0], bonus: true },
  ],
};

export function calcFreeSpinsAward(
  scatterCount: number,
  cfg: BuffaloReignConfig = DEFAULT_BUFFALO_REIGN_CONFIG,
): number {
...
export function normalizeBuffaloReignConfig(raw: unknown): BuffaloReignConfig {
  if (!raw || typeof raw !== "object") return structuredClone(DEFAULT_BUFFALO_REIGN_CONFIG);
  const obj = raw as Partial<BuffaloReignConfig>;
  const d = DEFAULT_BUFFALO_REIGN_CONFIG;
  ...
  const volatility: BuffaloReignConfig["volatility"] =
