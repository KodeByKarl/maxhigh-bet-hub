...
export const MAHJONG_WAYS_3_GAME_ID = "mahjong-ways-3";
...
export type MahjongWays3Config = {
  schemaVersion: 1;
  reelsCount: number;
...
export const DEFAULT_MAHJONG_WAYS_3_CONFIG: MahjongWays3Config = {
  schemaVersion: 1,
  reelsCount: 5,
  minReelHeight: 4,
  maxReelHeight: 4,
...
export function calcFreeSpinsAward(scatterCount: number, cfg: MahjongWays3Config = DEFAULT_MAHJONG_WAYS_3_CONFIG): number {
...
export function normalizeMahjongWays3Config(raw: unknown): MahjongWays3Config {
  if (!raw || typeof raw !== "object") return structuredClone(DEFAULT_MAHJONG_WAYS_3_CONFIG);
  const obj = raw as Partial<MahjongWays3Config>;
  const d = DEFAULT_MAHJONG_WAYS_3_CONFIG;
