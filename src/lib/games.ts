...
export const slotGames: SlotGame[] = [
  ...
  },
  {
    ...
    tag: "Hot",
    provider: "PG Soft",
    description: "The classic Chinese tile master game in 3D. Golden dragon wild transformations and endless cascade multipliers.",
    rating: 4.9,
    reviews: 8900,
    volatility: "High",
    maxWin: "25,000x",
    features: ["Golden Tiles", "Wild Transformation", "Increasing Multiplier"],
  },
  {
    ...defaults,
    id: "pinata-wins",
