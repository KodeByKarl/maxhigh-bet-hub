...
export const slotGames: SlotGame[] = [
  ...
  },
  {
    ...
    category: "slot",
    tag: "Hot",
    description: "Celebrate Gong Xi Fa Cai with Chinese New Year! Cascading zodiac wins, Tiger multiplier wilds, and festive firecracker free spins.",
    rating: 5.0,
    reviews: 820,
    rtp: "96.8%",
    volatility: "High",
    ...
    minBet: "₱0.20",
    maxBet: "₱200",
    features: ["Zodiac Cascades", "Firecracker Spins", "Tiger Multipliers", "Buy Bonus"],
  },
  {
    ...defaults,
    id: "golden-panther",
  ...
  },
  {
    ...
    volatility: "High",
    maxWin: "10,000x",
    features: ["Golden Cards", "Combo Multipliers", "Free Spins", "Buy Bonus"],
  },
  {
    ...defaults,
    id: "fortune-gems",
    ...
    tag: "Hot",
    provider: "JILI",
    description: "Unlock ancient temple riches with Fortune Gems! Radiant ruby & emerald multipliers with golden wheel spins.",
    rating: 4.8,
    reviews: 4200,
    volatility: "Medium",
    maxWin: "8,000x",
    features: ["Multiplier Reel", "Golden Wheel", "Sticky Gem Wilds"],
  },
  ...
  },
  {
    ...
    id: "pg-soft",
    name: "PG Soft",
    thumb: "/games/pg-soft.png",
    category: "slot",
    provider: "PG Soft",
    description: "Explore premium mobile slot titles from PG Soft with cutting edge 3D graphics and vertical gameplay.",
    rating: 5.0,
    reviews: 12400,
    volatility: "High",
    maxWin: "50,000x",
    features: ["3D Portrait Slots", "Cascading Reels", "Feature Buy"],
  },
  {
    ...defaults,
    id: "fc",
    ...
    category: "slot",
    provider: "Fa Chai",
    description: "Popular Asian luck and fortune slot games from Fa Chai Gaming.",
    rating: 4.8,
    reviews: 3100,
    volatility: "High",
    maxWin: "15,000x",
    features: ["God of Wealth", "Lucky Ingot Wilds", "Free Spin Boost"],
  },
];
