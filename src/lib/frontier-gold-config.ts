/**
 * Frontier Gold: Hold & Win — diamond connecting-ways western slot math.
...
export function totalCells(cfg: Pick<FrontierGoldConfig, "reelHeights">): number {
