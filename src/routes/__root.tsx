...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MaxHigh — Casino & Betting Dashboard" },
      { property: "og:description", content: "Play slots, mines, crash, dice, tower and wheel. Join daily and weekly races on MaxHigh." },
